 ...
 * 
 * Child compoent of `DoubleCircularProgress`
 * 
...
/**
 * Function: DoubleCircularProgress
 * 
 * @param {{ value:number, innerCicleSize:number, outerCicleSize:number, animationDuration:string }} argObject
 * * `value`: The progress value of the `<CircularProgress>`.
 ...
 * @returns {JSX.Element}
 */
export default function DoubleCircularProgress({ value = 50, innerCicleSize = 250, outerCicleSize = 300, animationDuration = '550ms' }) {
    //console.log('DoubleCircularProgress', value);
    ...
    return (
        ...
        <Box sx={{ flexGrow: 1 }}>
            <Box sx={{
                ...
                <RealtimeCircularProgress value={value} size={outerCicleSize} />
            </Box>
        </Box>
    );
}
