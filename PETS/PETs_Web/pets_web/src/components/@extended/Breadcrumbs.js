...
const Breadcrumbs = ({
  ...
  const getCollapse = (menu) => {
    if (menu.children) {
      menu.children.filter((collapse) => {
        ...
        } else if ((collapse.type && collapse.type === 'item') || (collapse.type && collapse.type === 'not-show')) {
  ...
  // if(item && item.title) {
  //   console.log(item.title.props.id.split('/'));
  // }
  ...
  // items
  if ((item && item.type === 'item') || (item && item.type === 'not-show')) {
          ...
          >
            {title && !titleBottom && (
              <Grid item>
                ...
                {/*      <Typography variant="h2">{item.title.props.id.split('/')[item.title.props.id.split('/').length-1]}</Typography>*/}
                {/*  ) : (*/}
                {/*      <Typography variant="h2">{item.title}</Typography>*/}
                {/*  )*/}
                {/*}*/}
