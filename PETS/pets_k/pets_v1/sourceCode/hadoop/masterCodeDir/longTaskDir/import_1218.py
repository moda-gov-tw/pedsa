...
#20221217 userID
from MyLib.updateAppStatusUserID import updateAppStatus
from MyLib.updateAppStatusUserID import updateAppProgress

#20221217 userID
# from MyLib.updateTProjectStatus import updateTProjectStatus
from MyLib.updateTProjectStatusUserID import updateTProjectStatus
...
def main():
    ...
    for tblName in tables.split(';'):
        ...
        try:
            ...
            if result['result'] == 0:
                ...
                updateTProjectStatus_.updateToMysql(project_id,userId, 99,"error")               
    ...
    project_status =3 
    statusname='去欄位屬性判定'
    updateTProjectStatus_.updateToMysql(project_id,userId, project_status,statusname)
