...
def DeIdAsync_longTask(self, _jsonBase64,nothing):
    ...
    # print cmdStr
    cmd=["python","app/devp/DeIdAsync.py","-pname",pname,"-prodesc",prodesc,"-powner",powner,"-p_dsname",p_dsname,"-step",step,"-configName",configName,"-hashTableName",hashTableName,"-hashkey",hashkey,"-sep",sep,"-columns_mac",columns_mac,"-dataHash",dataHash,"-onlyHash",onlyHash]
    print(cmd)
