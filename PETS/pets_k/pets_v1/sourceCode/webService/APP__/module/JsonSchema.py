...
#20. 20220613
class rmDataSchema(Schema):
    dateTime = fields.Str()
#21. 20220623 {"proj_name": "t1_porj"}
class rmDataByProjNameSchema(Schema):
    projName = fields.Str()
    userId = fields.Str()
    userAccount = fields.Str()
#22. 20220624
#fileName___time___errType___log
class msendToSendmailcenterSchema(Schema):
    fileName = fields.Str()
    timeStr = fields.Str()
    errType = fields.Str()
    log = fields.Str()
...
#23. 20230208
class getExporDataSchema(Schema):
    projName = fields.Str()
    userId = fields.Str()
    userAccount = fields.Str()

#20. {"proj_name": "t1_porj"}
#class projectNameSchema(Schema):
