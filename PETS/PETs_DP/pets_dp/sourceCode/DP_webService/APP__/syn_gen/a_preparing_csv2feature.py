...
def csv2feature(directory,datapath, col_name, tar_colname, transfer):
    ...
    with open(datapath, encoding='utf-8') as csvfile:
        ...
        with open(directory+'pkl/train_data.pickle', 'wb') as f:
            data = csv2dicts(data)
            data = data[::-1]
            pickle.dump(data, f, -1)
            #print(data[0])
            
    with open(directory+'pkl/train_data.pickle', 'rb') as f:
...
#     print(train_data_y[:10])
    ...
    with open(directory+'pkl/les.pickle', 'wb') as f:
        pickle.dump(les, f, -1)
#     print(les[0])

    with open(directory+'pkl/feature_train_data.pickle', 'wb') as f:
