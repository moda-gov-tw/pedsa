...
def main():
    ...
    try:
        ...
        delete_result = deleteExistReport(check_conn, projID, privacyType)
        check_conn.close()
...
if __name__ == '__main__':
    ...
    try:
        ...
        #copy raw data csv to /app/app/devp/PETs_data/
        ...
        #copy privacy data csv to /app/app/devp/PETs_data/
