...
def PETs_exportData_longTask(self, _jsonBase64,nothing):
    ...
    cmd = "python /app/app/devp/API/PETs_exportData.py {} {} {} \"{}\"".format(userID,projID,projName,str(dataName))
    _vlogger.debug(cmd)
    ...
    try:
        ...
        if stepList_[-1] == 'Mission Complete':
            updateToMysql_ProjectStatus(self, check_conn, projID, 10, u'資料匯出完成')
        else:
