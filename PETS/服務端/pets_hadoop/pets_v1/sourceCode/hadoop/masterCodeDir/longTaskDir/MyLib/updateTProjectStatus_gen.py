...
class updateTProjectStatus:
    ...
    def updateToMysql(self, dbName, project_id, project_status, statusname):
        self.project_id = project_id
        ...
        # self.condisionSampleData['privacy_type'] =  privacy_type 
        ...
        resultSampleData = self.conn.updateValueMysql(dbName,
                                                 'T_ProjectStatus',
                                                 self.condisionSampleData,
                                                 valueSampleData)
