...
class checkContainersStatus:
    ...
    def getDockerClient(self):
        ...
        #sed -i "s/tcp://34.81.119.49:2376', tls=tls_config)
        #tcp://34.81.119.49:2376', tls=tls_config)
        client=docker.DockerClient(base_url='tcp://34.81.119.49:2376', tls=tls_config)
