...
"""
Created on 20200708 DeIdGen_Async
...
#     print(cols_type)
    ...
    return col_cht, dataitem_id, float_col, cols_type, isNull_ 
...
def main(args):
    ...
    # debug log
    _logger  =_getLogger('error__DeidGenAsync')
    # verify log
    _vlogger =_getLogger('verify__DeidGenAsync')
    ...
    try:
        ...
        #step1:read json
        col_cht, id_col, float_col, datatype, isNull_ = select_cols(configPath)
        ...
        errMsg = 'DeIdGenAsync error: - %s:%s' %(type(e).__name__, e)
        _logger.debug('errTable: {0}'.format(str(errMsg)))
    '''
    ...
    if int(progress)==100:
        try:
            ...
            minKvalue = '3' #dict_data['minKvalue']
