...
def initSparkContext(name):
    ...
    try:
        ...
        warehouse_location = "hdfs://nodemasterS:9000/user/hive/warehouse"
...
#        print(dfK_finish.count())
        ...
        #warningCols = {key: value for key, value in warningCols.items() if value > int(k_value)}
        filtered_warningCols = {}

        for key, value in warningCols.items():
            if value >= k_value:
                filtered_warningCols[key] = value        
        _logger.debug("$$$$$$$$$$$$$$$$$$$$$$$$")
        _logger.debug(filtered_warningCols)
        _logger.debug("$$$$$$$$$$$$$$$$$$$$$$$$")
        warningCols = filtered_warningCols
        cols = list()
        counts = list()
