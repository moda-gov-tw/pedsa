    ...
    insert into DeIdService.T_Member(useraccount,username,password,dept_id,isAdmin,createtime)value('deidadmin','deidadmin','26e7a2b13ab39e1b8b70b41a3be4e7dd',(select id from DeIdService.T_Dept where dept_name='ITRI_CITC'),1,now());
    ###########################################
