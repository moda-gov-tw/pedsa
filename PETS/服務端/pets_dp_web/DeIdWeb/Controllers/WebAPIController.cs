                        ...
                        if (lstproject.Count > 0)
                        {
                            ...
                            switch (proj_status)
                            {
                                ...
                                case 3:
                                    ...
                                    return_url += "/ProjectStep/Step3?proj_id=" + WebUtility.UrlEncode(project_id.ToString()) + "&project_name=" + WebUtility.UrlEncode(projectName) + "&stepstatus=" + WebUtility.UrlEncode(proj_status.ToString());
                                    break;
                                case 4:
                                    statusname = "概化與資料關聯處理中";
