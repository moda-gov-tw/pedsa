    ...
    #=====================================
    #20:Group
    CREATE TABLE SynService.T_Group (
    ...
    #=============================
    #21:GroupMember
    CREATE TABLE SynService.T_GroupMember (
    ...
    #==============================================
    #22:JoinMember
    CREATE TABLE SynService.T_Project_JoinMember (
        Pj_Id INT(11) NOT NULL auto_increment PRIMARY KEY,
        Member_Id INT(11) NOT NULL,
        Project_Id INT(11) NOT NULL,
        createuser VARCHAR(100) NOT NULL,
        updateuser VARCHAR(100),
...
INSERT INTO SynService.T_Member (dept_id,useraccount,isAdmin,password,createtime) VALUES ('1','deidadmin','1','26e7a2b13ab39e1b8b70b41a3be4e7dd',now());
