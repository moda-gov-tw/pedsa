...
def multiplehash_resend_longTask(self, projName,projID,identifier,onlyHash,userId="1",userAccount="deidadmin"):
    ...
    try:
        ...
        sparkCode = getConfig().getSparkCode('multiplehash_resend.py')
