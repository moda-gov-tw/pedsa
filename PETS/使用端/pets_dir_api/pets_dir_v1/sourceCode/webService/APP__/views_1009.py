...
from . import task_multipleHash,task_multipleHash_new,task_multipleHash_identifier,task_check_identifier
...
#######################################
        ...
        if resultCheck2["fetchall"] == [] or len(resultCheck2["fetchall"])==0:
            ...
            # response['project_name'] = T_Pets_Project_project_name
            # response['project_eng'] = T_Pets_MemberProjectRole_project_eng
            # response['enc_key'] = T_Pets_MemberProjectRole_enc_key
##########################################
...
def check_identifier_async():
    ...
    try: # fetch parameter: pid
        ...
        if resultCheck["fetchall"] == [] or len(resultCheck["fetchall"])==0:
            ...
            response['check'] = "yes"
        response['resultCheck'] = resultCheck
        # if int(resultCheck['result'])==1:
    ...
    # pid = 999
    # try:
    #     identifier_code_para = {"identifier_code":identifier_code}
    #     print('identifier_code_para: ', identifier_code_para)
    #     log_time.printLog("######################")      
    #     log_time.printLog(identifier_code_para)      
    #     log_time.printLog("######################")       

    #     response_g = requests.post("https://"+flask_ip+":"+flask_port+"/c_identifier_async", json=identifier_code_para,timeout=None, verify=False)
    #     response_dic = response_g.json()
    #     print("identifier_code_para JSON: ",response_dic)
    #     response['HashMac']='1' #response_dic['state']
    #     #return make_response(jsonify(response))
    # except Exception as e:
    #     response = dict()
