...
def multiplehash_longTask(self, tblName,key,sep,columns_mac,projName,projID,dateHash,onlyHash,AES_key,AES_columns_mac,userId="1",userAccount="deidadmin"):
    ...
    try:
        ...
        sparkCode = getConfig().getSparkCode('multiplehash_identifier.py')
