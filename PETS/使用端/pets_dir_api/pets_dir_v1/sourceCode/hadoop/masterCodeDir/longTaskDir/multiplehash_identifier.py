...
def main__(tblName,sep,columns_mac,projName,projID,dataHash,onlyHash,AES_columns_mac,project_cert,service_ip,userId,userAccount):
    tets = 11
        ...
        if 0:
            ...
            if result['result'] == 0:
                ...
                #解密
                    ...
                    # statusname='AES_F'
                    projID = 99999
                    updateTProjectStatus_.updateToMysql(projID, project_status,statusname,service_ip,str(tableName_)+".csv")
...
if __name__ == "__main__":
    ...
    main__(tblName,sep,columns_mac,projName,projID,dataHash,onlyHash,AES_columns_mac,project_cert,service_ip,userId,userAccount)
