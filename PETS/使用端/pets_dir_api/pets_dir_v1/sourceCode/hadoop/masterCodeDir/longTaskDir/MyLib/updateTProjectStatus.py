...
class updateTProjectStatus:
    ...
    def __init__(self,project_id = 99999,userId=1):
    ...
    def updateToMysql(self, project_id, project_status, statusname,service_ip,dataset_name,identifier):
        self.project_id = project_id
        ...
        # resultSampleData = self.conn.insertValue('DeIdService',
        #                                          'T_ProjectStatus',
        #                                          valueSampleData,
        #                                          True)
    ...
    def updateToMysql_resend(self, project_id, project_status, statusname,identifier):
        self.project_id = project_id
